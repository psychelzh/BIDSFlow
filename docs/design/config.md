...
- no scheduler template files are generated by `init`
- missing-template behavior is planned for a later implementation step
...
- how a future template-generation command should create or update
  scheduler scripts without overwriting site-specific edits
